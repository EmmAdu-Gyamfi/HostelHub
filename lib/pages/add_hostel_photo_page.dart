...
class AddHostelPhotoMobilePage extends StatefulWidget {


  final Hostel hostel;
  const AddHostelPhotoMobilePage({Key? key, required this.hostel}) : super(key: key);

  @override
  State<AddHostelPhotoMobilePage> createState() => _AddHostelPhotoMobilePageState();
}

class _AddHostelPhotoMobilePageState extends State<AddHostelPhotoMobilePage> {
