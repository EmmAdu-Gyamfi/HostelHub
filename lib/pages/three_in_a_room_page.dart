...
class ThreeInARoomMobilePage extends StatefulWidget {
  final List<HostelRooms> rooms;
  final String hostelName;
  const ThreeInARoomMobilePage({Key? key, required this.rooms, required this.hostelName}) : super(key: key);

  @override
  State<ThreeInARoomMobilePage> createState() => _ThreeInARoomMobilePageState();
}

class _ThreeInARoomMobilePageState extends State<ThreeInARoomMobilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    var threeinARoom = rooms.where((e) => e.room.roomCategory == "Three In a Room").toList();
    return   Container(
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Text("Three in a room", style: GoogleFonts.roboto(color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold),),
          ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    threeinARoom.isEmpty ? Container(
                      child:Padding(
                              ...
                              itemBuilder: (context, index){
                                if(index%2 == 0){
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      onTap: (){
                                        MyNavigator.navigateTo(context, RoomGalleryMobilePage(photos:   threeinARoom[index].room.roomPhotos));
                                      },
                                      child: Container(
                                        width: 280,
                                        color: Color.fromRGBO(252, 248, 247, 1),
                                                ...
                                                child: Container(
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: CachedNetworkImage(
                                                      ...
                                                      fit: BoxFit.fill,
                                                      imageUrl: "$baseUrl/FileStore/${  threeinARoom[index].room.roomPhotos[0].fileId}",
                                                      httpHeaders: {
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: Text("${threeinARoom[index].room.roomCategory}", style: GoogleFonts.merriweather(fontWeight: FontWeight.bold, fontSize: 18),),
                                                            // color: Colors.pinkAccent,
                                                          ),

                                                          Container(

                                                            child: Text("${  threeinARoom[index].room.roomLabel}", style: GoogleFonts.merriweather(fontWeight: FontWeight.normal, fontSize: 16),),
                                                            // color: Colors.pinkAccent,
                                                          ),
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Text("₵${  threeinARoom[index].room.price}", style: GoogleFonts.merriweather(fontWeight: FontWeight.bold, color: Colors.green, fontSize: 16),),
