...
class OneInARoomMobilePage extends StatefulWidget {
  final List<HostelRooms> rooms;
  final String hostelName;

  const OneInARoomMobilePage({Key? key, required this.rooms, required this.hostelName}) : super(key: key);

  @override
  State<OneInARoomMobilePage> createState() => _OneInARoomMobilePageState();
}

class _OneInARoomMobilePageState extends State<OneInARoomMobilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    var oneinARoom = rooms.where((e) => e.room.roomCategory == "One In a Room").toList();
    return   Container(
      ...
      child: Stack(
        ...
        // ),
          ...
          Positioned(
            ...
            child: Text("One in a room", style: GoogleFonts.roboto(color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold),),
          ),
                          ...
                          child: ListView.builder(
                              ...
                              if(index%2 == 0){
                                return Padding(
                                  ...
                                  child: InkWell(
                                    onTap: (){
                                      MyNavigator.navigateTo(context, RoomGalleryMobilePage(photos: oneinARoom[index].room.roomPhotos));
                                    },
                                    child: Container(
                                      width: 280,
                                      color: Color.fromRGBO(252, 248, 247, 1),
                                              ...
                                              child: Container(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: CachedNetworkImage(
                                                    ...
                                                    fit: BoxFit.fill,
                                                    imageUrl: "$baseUrl/FileStore/${oneinARoom[index].room.roomPhotos[0].fileId}",
                                                    httpHeaders: {
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Container(
                                                            ...
                                                            child: Text("${oneinARoom[index].room.roomCategory}", style: GoogleFonts.merriweather(fontWeight: FontWeight.bold, fontSize: 18),),
                                                            // color: Colors.pinkAccent,
                                                        ),

                                                        Container(

                                                          child: Text("${oneinARoom[index].room.roomLabel}", style: GoogleFonts.merriweather(fontWeight: FontWeight.normal, fontSize: 16),),
                                                          // color: Colors.pinkAccent,
                                                        ),
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              Text("₵${oneinARoom[index].room.price}", style: GoogleFonts.merriweather(fontWeight: FontWeight.bold, color: Colors.green, fontSize: 16),),
