...
class TwoInARoomMobilePage extends StatefulWidget {
  final List<HostelRooms> rooms;
  final String hostelName;
  const TwoInARoomMobilePage({Key? key, required this.rooms, required this.hostelName}) : super(key: key);

  @override
  State<TwoInARoomMobilePage> createState() => _TwoInARoomMobilePageState();
}

class _TwoInARoomMobilePageState extends State<TwoInARoomMobilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    var twoinARoom = rooms.where((e) => e.room.roomCategory == "Two In a Room").toList();
    return   Container(
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Text("Two in a room", style: GoogleFonts.roboto(color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold),),
          ),
                              ...
                              itemBuilder: (context, index){
                                if(index%2 == 0){
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      onTap: (){
                                        MyNavigator.navigateTo(context, RoomGalleryMobilePage(photos:   twoinARoom[index].room.roomPhotos));
                                      },
                                      child: Container(
                                        width: 280,
                                        color: Color.fromRGBO(252, 248, 247, 1),
                                                ...
                                                child: Container(
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: CachedNetworkImage(
                                                      ...
                                                      fit: BoxFit.fill,
                                                      imageUrl: "$baseUrl/FileStore/${  twoinARoom[index].room.roomPhotos[0].fileId}",
                                                      httpHeaders: {
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: Text("${twoinARoom[index].room.roomCategory}", style: GoogleFonts.merriweather(fontWeight: FontWeight.bold, fontSize: 18),),
                                                            // color: Colors.pinkAccent,
                                                          ),

                                                          Container(

                                                            child: Text("${  twoinARoom[index].room.roomLabel}", style: GoogleFonts.merriweather(fontWeight: FontWeight.normal, fontSize: 16),),
                                                            // color: Colors.pinkAccent,
                                                          ),
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Text("₵${  twoinARoom[index].room.price}", style: GoogleFonts.merriweather(fontWeight: FontWeight.bold, color: Colors.green, fontSize: 16),),
